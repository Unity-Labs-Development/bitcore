...
sudo docker pull registry-intl.cn-hongkong.aliyuncs.com/vgo/bitcore-nginx:latest
sudo docker tag registry-intl.cn-hongkong.aliyuncs.com/vgo/bitcore-nginx:latest bitcore-nginx:latest
